...
const STEP_META = [
  {
    ...
    subtitle: 'Add every stream that hits your account',
    hint: 'More sources = better sim accuracy',
  },
  {
    eyebrow: 'Step 2 of 4',
    title: 'Expenses & Debt',
    subtitle: 'Fixed costs, EMIs, and loan obligations',
    hint: 'Include all EMIs even if small',
  },
  {
    eyebrow: 'Step 3 of 4',
    title: 'Financial Goals',
    subtitle: 'What are you working towards?',
    hint: 'Pick up to 3, Penny tracks all',
  },
  {
    eyebrow: 'Step 4 of 4',
    title: 'Strategy & Surplus',
    subtitle: 'How should Penny plan your journey?',
    hint: 'Change this any time in settings',
  },
];
    ...
    <div className="h-[100dvh] w-full flex flex-col md:flex-row bg-background overflow-hidden relative">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex justify-between items-center">
                ...
                <span
                  ...
                  style={{ fontSize: 'var(--text-xs)', color: 'var(--card-foreground)' }}
                >
      ...
      <div ref={rightRef} className="flex-1 h-full overflow-y-auto relative z-10">
        ...
        <div className="flex md:hidden items-center justify-between px-4 pt-5 pb-3">
          ...
          >
            {isDark ? (
              <Sun size={14} className="icon-wireframe" />
            ) : (
              <Moon size={14} className="icon-wireframe" />
            )}
          </button>
        </div>
        ...
        <div className="flex flex-col items-center px-4 md:px-8 pb-16 pt-2 md:pt-16">
          <div className="max-w-[720px] w-full">
            <p
              ...
              style={{ fontSize: 'var(--text-xs)', color: 'var(--secondary)' }}
            >
              Step {form.step + 1} of {form.TOTAL_STEPS} · {form.TOTAL_STEPS - form.step - 1} step
            ...
            >
              {form.step === 0 && (
                <OnboardingStepIncome
                  ...
                  netRate={form.netRate}
                  onChangeNetRate={form.setNetRate}
                />
              )}
